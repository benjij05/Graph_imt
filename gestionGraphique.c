            ...
            case SDL_KEYDOWN:
                ...
                if (shiftPressed) {
                        switch (key) {
                            ...
                            case SDLK_KP_0: pdirection = '0'; break;
                            case SDLK_KP_1: pdirection = '1'; break;
                            case SDLK_KP_2: pdirection = '2'; break;
                            case SDLK_KP_3: pdirection = '3'; break;
                            case SDLK_KP_4: pdirection = '4'; break;
                            case SDLK_KP_5: pdirection = '5'; break;
                            case SDLK_KP_6: pdirection = '6'; break;
                            case SDLK_KP_7: pdirection = '7'; break;
                            case SDLK_KP_8: pdirection = '8'; break;
                            case SDLK_KP_9: pdirection = '9'; break;
